...
def create_MBTI_questionnaire():
    ...
    questionnaire = LikertQuestionnaire.objects.create(
        ...
        dashboard_message='In order to complete your profile, please answer the <b class="contrast-color">First Questionnaire</b> in your <i>Questionnaires to Answer</i> section</p>'
    )
